...
class FollowingPartiesAdapter(val Parties: List<Party>) :
    RecyclerView.Adapter<FollowingPartiesAdapter.FollowingPartiesViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FollowingPartiesViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.single_party, parent, false)
